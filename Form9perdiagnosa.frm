...
Begin VB.Form Form9 
   BackColor       =   &H00008000&
   Caption         =   "Laporan Data Per Diagnosa"
   ClientHeight    =   4560
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   6765
   ...
   Begin VB.Image Image1 
      Height          =   1395
      Left            =   120
      Picture         =   "Form9perdiagnosa.frx":0000
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1365
   End
   Begin VB.Label Label9 
      BackColor       =   &H00008000&
      Caption         =   "Menu ini digunakan untuk melihat data Per Diagnosa"
      ForeColor       =   &H8000000B&
      Height          =   255
      Left            =   2040
      TabIndex        =   8
...
Call BukaDB
RSBarang.Open "Select * from data_diagnosa where Kode_diagnosa like '%" & Combo6 & "%'", Koneksi
...
With CrystalReport1
        ...
        .ReportFileName = App.Path & "\Reportdatakunjungandiagnosa.rpt"
      .SelectionFormula = "{data_pemeriksaan.Kode_diagnosa}='" + Combo6 + "'"
        .ParameterFields(0) = "Diagnosa;" & Text5.Text & ";True"
...
Combo6.AddItem RSBarang!Kode_diagnosa
RSBarang.MoveNext
Loop
RSBarang.close
