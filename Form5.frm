...
Dim TambahObat As String
    TambahObat = "Insert Into data_obat values ('" & Text1 & "','" & Text2 & "')"
...
Call BukaDB
Dim HapusObat As String
    HapusObat = "Delete From data_obat where Kode_obat='" & Text1 & "'"
    Koneksi.Execute HapusObat
...
Dim EditObat As String
    EditObat = "update data_obat Set Nama_obat= '" & Text2 & "' where Kode_obat='" & Text1 & "'"
...
RSBarang.Open "Select * from data_obat where Nama_obat like '%" & Text9 & "%'", Koneksi
...
On Error Resume Next
    Call BukaDB
    RSBarang.Open "Select * from data_obat where Kode_obat = '" & DataGrid1.Columns(0) & "'", Koneksi
    If Not RSBarang.EOF Then
        Text1 = RSBarang!Kode_obat
        Text2 = RSBarang!Nama_obat
